...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div region="north" split="true" border="false"
		...
		<span style="float: right; padding-right: 20px;" class="head"><span
			...
			href="SystemServlet?method=LoginOut" id="loginOut">安全退出</a></span> <span
			style="padding-left: 10px; font-size: 16px;">SDU学生信息管理系统</span>
	</div>
	<div region="south" split="true"
		style="height: 30px; background: #D2E0F2;">
		<div class="footer">Copyright &copy; SDU By Bury_light</div>
	</div>
