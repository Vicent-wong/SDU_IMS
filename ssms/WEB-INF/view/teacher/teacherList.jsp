...
<body>
	...
	<div id="addDialog" style="padding: 10px;">
		<div
			style="position: absolute; margin-left: 560px; width: 250px; height: 300px; border: 1px solid #EEF4FF"
			id="photo">
			<img alt="照片" style="max-width: 250px; max-height: 300px;" title="照片"
				src="photo/teacher.jpg" />
		</div>
		<form id="addForm" method="post">
			<table id="addTable" border=0
				...
				<tr>
					...
					<td colspan="3"><input id="add_number" class="easyui-textbox"
		...
		<form id="editForm" method="post">
			<table id="editTable" border=0
				...
				<tr>
					...
					<td colspan="3"><input id="edit_number"
