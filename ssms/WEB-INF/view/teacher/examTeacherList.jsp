...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;">
			<a id="register" href="javascript:;" class="easyui-linkbutton"
				data-options="iconCls:'icon-vcard-edit',plain:true">登记成绩</a>
		</div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div>
			...
			<table id="addTable" border=0
				...
				<tr>
					...
					<td><input style="width: 200px; height: 30px;"
						...
						value="平时考试" /> <input type="hidden" name="type" value="2" /></td>
				</tr>
				<tr>
					<td>备注:</td>
