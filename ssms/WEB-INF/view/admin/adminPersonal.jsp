	...
	<div id="editDialog" style="padding: 20px;">
		<div style="width: 650px">
			<table id="systemTable"
				...
				style="width: 650px" cellpadding="8">
				<tr>
					<td width="200">学校名称:</td>
					<td width="350"><input id="school_name"
						value="${systemInfo.schoolName}" class="easyui-textbox"
						style="width: 300px; height: 30px;" type="text" name="schoolName" />
					</td>
					<td width="100"><a data-options="iconCls:'icon-save'"
						class="easyui-linkbutton">保存</a></td>
				</tr>
				<tr>
					<td>禁止教师<br />登录系统
					</td>
					<td><input id="forbid_teacher"
						${systemInfo.forbidTeacher == 1 ? 'checked' : ''} type="checkbox"
						name="forbidTeacher" /></td>
					<td><a data-options="iconCls:'icon-save'"
						class="easyui-linkbutton">保存</a></td>
				</tr>
				<tr>
					<td>禁止学生<br />登录系统
					</td>
					<td><input id="forbid_student"
						${systemInfo.forbidStudent == 1 ? 'checked' : ''} type="checkbox"
						name="forbidStudent" /></td>
					<td><a data-options="iconCls:'icon-save'"
						class="easyui-linkbutton">保存</a></td>
				</tr>
				<tr>
					<td>教师通知:</td>
					<td><input id="notice_teacher"
						value="${systemInfo.noticeTeacher}"
						style="width: 300px; height: 70px;" data-options="multiline: true"
						class="easyui-textbox" type="text" name="noticeTeacher" /></td>
					<td><a data-options="iconCls:'icon-save'"
						class="easyui-linkbutton">保存</a></td>
				</tr>
				<tr>
					<td>学生通知:</td>
					<td><input id="notice_student"
						value="${systemInfo.noticeStudent}"
						style="width: 300px; height: 70px;" data-options="multiline: true"
						class="easyui-textbox" type="text" name="noticeStudent" /></td>
					<td><a data-options="iconCls:'icon-save'"
						class="easyui-linkbutton">保存</a></td>
				</tr>
			</table>
			...
			<table cellpadding="8">
				...
				<tr>
					...
					<td><input type="hidden" name="account"
						value="${user.account }" /> <input id="new_password"
						style="width: 200px; height: 30px;" class="easyui-textbox"
