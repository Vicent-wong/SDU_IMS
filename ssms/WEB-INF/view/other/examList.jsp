...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="float: left;">
			<a id="escore" href="javascript:;" class="easyui-linkbutton"
				data-options="iconCls:'icon-chart_bar',plain:true">成绩统计</a>
		</div>
	...
	<div id="escoreToolbar">
		<a id="redo" href="javascript:;" class="easyui-linkbutton"
			...
			style="margin-left: 10px;">班级：<input id="escoreClazzList"
			class="easyui-textbox" name="clazz" /></span>
	</div>
			...
			<table cellpadding="8">
				...
				<tr>
					...
					<td><input id="add_time" style="width: 200px; height: 30px;"
						class="easyui-datebox" type="text" name="etime"
						data-options="required:true, missingMessage:'请选择日期', editable:false" /></td>
				</tr>
				<tr>
					<td>考试类型:</td>
					<td><input style="width: 200px; height: 30px;"
						class="easyui-textbox" data-options="readonly: true" type="text"
						value="年级统考" /> <input type="hidden" name="type" value="1" /></td>
				</tr>
				<tr>
					<td>年级:</td>
					<td><input id="add_gradeList"
