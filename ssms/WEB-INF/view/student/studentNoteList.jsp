			...
			<table cellpadding="8">
				<tr>
					...
					<td><input id="edit_number" data-options="readonly: true"
						...
						type="text" name="number" data-options="readonly:true" /></td>
				</tr>
				<tr>
					<td>姓名:</td>
				...
				<tr>
					...
					<td><input id="edit_qq" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="qq"
						data-options="readonly:true" /></td>
				</tr>
				<tr>
					<td>年级:</td>
					<td><input id="edit_grade" style="width: 200px; height: 30px;"
						class="easyui-textbox" data-options="readonly:true" name="gradeid" /></td>
				</tr>
				<tr>
					<td>班级:</td>
					<td><input id="edit_clazz" style="width: 200px; height: 30px;"
						class="easyui-textbox" data-options="readonly:true" name="clazzid" /></td>
				</tr>
			</table>
		</form>
	</div>
